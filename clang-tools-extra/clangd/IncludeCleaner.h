...
/// Affects whether angle bracket includes ("system" headers) should be
/// considered for removal. This is off by default for now because umbrella
/// headers are not supported.
/// FIXME: remove this hack when umbrella headers are supported.
void setIncludeCleanerAnalyzesSystemHeaders(bool B);
